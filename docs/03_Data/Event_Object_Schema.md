...
{
  "deltas": [
    { "target_id": "char_b", "op": "sub", "path": "stats.hp", "val": 35, "metadata": { "critical_hit": true, "damage_type": "fire", "source_skill": "fireball_lv3" } },
    { "target_id": "char_a", "op": "transfer", "path": "inventory.sword_01", "val": "ground", "metadata": {} },
    { "target_id": "world", "op": "set", "path": "flags.war_started", "val": true, "metadata": { "trigger": "quest_completion" } }
  ]
}
```
